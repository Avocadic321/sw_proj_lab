 ...
 * <p>
 * This class provides common structural properties shared by all elements such as pipes, pumps, cisterns, and springs,
 * and enables them to participate in the network connectivity structure. Elements also manage player occupancy, as
 * players can stand on them during the game.
 * </p>
 * <p>
 * Subclasses must implement their own occupancy rules by overriding {@link #canOccupy()}. By default, elements allow an
 * unlimited number of players to occupy them simultaneously.
 * </p>
 *
 * @see Player
 * @see Pipe
...
public abstract class Element {
     ...
     * <p>
     * Called when a player successfully moves onto this element. The caller should verify that {@link #canOccupy()}
     * returns {@code true} before invoking this method.
     * </p>
     *
     ...
     * <p>
     * Called when a player moves away from this element. If the specified player is not an occupant, the method has no
     * effect.
     * </p>
     *
     ...
     * <p>
     * The default implementation returns {@code true}, allowing any number of players to occupy the element. Subclasses
     * should override this method to enforce specific occupancy constraints:
     * <ul>
     ...
     * </p>
     *
     * @return {@code true} if a player can occupy this element, {@code false} otherwise
     */
