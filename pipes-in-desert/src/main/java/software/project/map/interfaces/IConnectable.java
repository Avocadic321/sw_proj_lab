 ...
 * </p>
 * <p>
 * This interface provides a uniform way to manage the network structure across different types of active elements. Each
 * connectable element has a maximum number of connections it can support (e.g., a pump's maxConnections limit).
 * </p>
 */
public interface IConnectable {
     ...
     * <p>
     * The operation succeeds only if the element has not yet reached its connection limit (e.g., a pump's
     * maxConnections) and the pipe end is currently free.
     * </p>
     *
     ...
     * <p>
     * The pipe end must be currently connected to this element. After disconnection, the pipe end becomes free and the
     * element removes the pipe end from its connections list.
     * </p>
     *
